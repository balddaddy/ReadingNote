...
梯度指向各点处函数值降低的方向，并且是各点处函数值减小最多的方向。
...
* 作者：约翰.惠特默
* 核心内容：GROW教练模型。通过辅导员向被辅导对象提问，让被辅导对象自己解决问题。GROW是指目标-Goal，现状-Reality，选择-Option，意愿-Will。
* GROW的关键原则：提高自我认知/建立自我责任。教练绝对不应该介入到对方问题当中，不应该思考对方的问题。当你开始思考对方问题该如何解决的时候，教练就开始失败了。
* Goal：目标设定的常用问题包括：
  1. 你的目标是什么？
  2. 如果你知道答案的话，那是什么？
  3. 具体的目标是什么？
